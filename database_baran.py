...
class Database:
    ...
    def update_item(self, item):
        ...
        :param item: An instance of the Item class that is used to update the existing game.
        """
    ...
    def delete_item_from_user(self, item_id, user_id):
        ...
        :param user_id: ID of the user that the item will be deleted from.
        """
    ...
    def get_items(self, game_id):
        """
        Gets all items for the game.

        :param game_id: ID of the game that the items will be listed for.
        :return: List of items of the game.
        """
    ...
    def add_item_to_user(self, item_id, game_id, user_id):
        ...
        If the user already owns the item, it only increments the level of the item.
        Otherwise it adds the item to the user. In this case,
        it also increments the number of items that the user owns for a game specified with a game_id.
    ...
    def get_items_of_user(self, user_id):
        """
        Gets all the items that a user owns.

        :param user_id: ID of the user.
        :return: List of items that the user owns.
        """
    ...
    def edit_item(self, item_id, new_color, new_status, is_equipped):
        ...
        :param item_id: ID of the item.
        :param new_color: The new color attribute of the item.
        :param new_status: The new status attribute of the item.
        :param is_equipped: The attribute of an item that specifies if the item is being equipped.
        """
    ...
    def get_screenshot_comments(self, game_id, screenshot_id):
        """
        Gets all of the comments for a screenshot.

        :param game_id: ID of the game.
        :param screenshot_id: ID of the screenshot.
        :return: List of comments for the screenshot.
        """
    ...
    def add_screenshot_comment(self, user_id, game_id, screenshot_id, content, reaction, font_size, color):
        """
        Adds a comment for a screenshot.

        :param user_id: ID of the user who leaves the comment.
        :param game_id: ID of the game where the screenshot belongs.
        :param screenshot_id: ID of the screenshot.
        :param content: The content of the comment.
        :param reaction: Reaction of the comment.
        :param font_size: Font size of the comment.
    ...
    def delete_screenshot_comment(self, comment_id):
        """
        Deletes a comment from a screenshot.
    ...
    def update_screenshot_comment(self, comment_id, user_id, game_id, screenshot_id, content, reaction, font_size, color):
        """
        Edits a screenshot comment.

        :param comment_id: ID of the comment to be edited.
        :param user_id: ID of the user who left the comment.
        :param game_id: ID of the game.
        :param screenshot_id: ID of the screenshot.
        :param content: Edited content for the comment.
        :param reaction: Edited reaction for the comment.
        :param font_size: Edited font size for the comment.
        :param color: Edited color for the comment.
        """
